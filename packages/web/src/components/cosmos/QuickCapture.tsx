...
export const QuickCapture: React.FC = () => {
  ...
  return (
    <div className="space-y-4">
      <Label className="px-2 text-white/40 uppercase tracking-[0.2em] font-black text-[10px]">Universal Capture</Label>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {captureMethods.map((method) => (
          ...
          >
            <Glass className="p-6 flex flex-col items-center justify-center gap-3 border-white/5 hover:border-[var(--theme-primary)]/40 transition-all aspect-square lg:aspect-auto lg:h-32">
