  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between px-2">
        <Label className="text-white/40 uppercase tracking-[0.2em] font-black text-[10px]">Crew Broadcast</Label>
      ...
      <div className="space-y-3">
        {broadcasts.length === 0 && (
          <div className="text-center py-8 opacity-20 text-[10px] font-black uppercase tracking-widest">No recent updates</div>
        )}
        {broadcasts.map((broadcast, i) => (
          ...
          >
            <Glass className="p-4 border-white/5 hover:border-[var(--theme-primary)]/20 transition-all group">
              <div className="flex gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-center mb-1">
                    <span className="text-[10px] font-black text-white/60 uppercase">{broadcast.sender}</span>
                  ...
                  <p className="text-xs text-white/80 font-medium leading-relaxed truncate group-hover:text-white transition-colors">
                    {broadcast.message}
                  </p>
                </div>
              </div>
